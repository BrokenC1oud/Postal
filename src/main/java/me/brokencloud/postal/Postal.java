...
import me.brokencloud.postal.command.PostalCommandTabCompletion;
...
public final class Postal extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        Objects.requireNonNull(getCommand("postal")).setTabCompleter(new PostalCommandTabCompletion());
